...
def upgrade() -> None:
    ...
    sa.Column('schedule_type', sa.Enum('WEEKLY', 'DATE_RANGE', 'AD_HOC', name='scheduletype'), nullable=False),
...
def downgrade() -> None:
    ...
    sa.Column('status', postgresql.ENUM('ACTIVE', 'COMPLETED', 'CANCELLED', name='schedulestatus'), autoincrement=False, nullable=True),
